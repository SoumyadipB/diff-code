...
angular
    ...
    .controller('AppController', ['$scope', '$http', 'FileUploader', function($scope, $http, FileUploader) {
        var uploader = $scope.uploader = new FileUploader({
            url: '/PathLossISFFileUpload/fileUpload/uploadMultipleFiles'
        });
        
        $scope.startService	=	function() {
        	var serviceUrl	=	"/PathLossISFFileUpload/fileUpload/startPathLossService/";
        	...
        	$http.get(serviceUrl).then(function(response){
				...
				alert("unable to start service :"+error);
