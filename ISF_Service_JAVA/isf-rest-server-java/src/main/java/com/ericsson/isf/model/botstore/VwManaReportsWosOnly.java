...
/**
 * VwManaReportsWosOnly generated by hbm2java
 */
@Entity
@Table(name = "vw_MANA_Reports_WOs_Only", schema = "dbo")
public class VwManaReportsWosOnly implements java.io.Serializable {

	private VwManaReportsWosOnlyId id;

	public VwManaReportsWosOnly() {
	}

	public VwManaReportsWosOnly(VwManaReportsWosOnlyId id) {
		this.id = id;
	}
	...
	public VwManaReportsWosOnlyId getId() {
		return this.id;
	}

	public void setId(VwManaReportsWosOnlyId id) {
		this.id = id;
	}
