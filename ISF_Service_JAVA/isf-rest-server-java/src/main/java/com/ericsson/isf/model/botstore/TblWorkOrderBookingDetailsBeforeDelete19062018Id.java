...
/**
 * TblWorkOrderBookingDetailsBeforeDelete19062018Id generated by hbm2java
 */
@Embeddable
public class TblWorkOrderBookingDetailsBeforeDelete19062018Id implements java.io.Serializable {
	...
	public TblWorkOrderBookingDetailsBeforeDelete19062018Id() {
	}

	public TblWorkOrderBookingDetailsBeforeDelete19062018Id(int bookingId) {
		this.bookingId = bookingId;
	}

	public TblWorkOrderBookingDetailsBeforeDelete19062018Id(int bookingId, Integer woid, Integer taskId, Date startDate,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TblWorkOrderBookingDetailsBeforeDelete19062018Id))
			return false;
		TblWorkOrderBookingDetailsBeforeDelete19062018Id castOther = (TblWorkOrderBookingDetailsBeforeDelete19062018Id) other;
