...
/**
 * TblWoCycleTimeJobDone generated by hbm2java
 */
@Entity
@Table(name = "tbl_WO_Cycle_time_JobDone", schema = "transactionalData")
public class TblWoCycleTimeJobDone implements java.io.Serializable {

	private TblWoCycleTimeJobDoneId id;

	public TblWoCycleTimeJobDone() {
	}

	public TblWoCycleTimeJobDone(TblWoCycleTimeJobDoneId id) {
		this.id = id;
	}
	...
	@AttributeOverrides({ @AttributeOverride(name = "marketAreaName", column = @Column(name = "MarketAreaName")),
			...
			@AttributeOverride(name = "woNumber", column = @Column(name = "WO Number")),
			...
			@AttributeOverride(name = "woactualStartDate", column = @Column(name = "WOActualStartDate", length = 16)),
			@AttributeOverride(name = "woactualEndDate", column = @Column(name = "WOActualEndDate", length = 16)),
			...
			@AttributeOverride(name = "woActualEndDateTime", column = @Column(name = "WO Actual End DateTime", length = 23)),
			...
			@AttributeOverride(name = "compliance", column = @Column(name = "Compliance", nullable = false, length = 19)),
			...
			@AttributeOverride(name = "weekSubActivity", column = @Column(name = "WeekSubActivity", length = 530)),
			@AttributeOverride(name = "cycleTime", column = @Column(name = "Cycle Time", precision = 36)) })
	public TblWoCycleTimeJobDoneId getId() {
		return this.id;
	}

	public void setId(TblWoCycleTimeJobDoneId id) {
		this.id = id;
	}
