...
/**
 * VwManaReportsWosOnlyId generated by hbm2java
 */
@Embeddable
public class VwManaReportsWosOnlyId implements java.io.Serializable {
	...
	public VwManaReportsWosOnlyId() {
	}

	public VwManaReportsWosOnlyId(double sla, int woid, String failureReason, String statusComment) {
		this.sla = sla;
		this.woid = woid;
	...
	public VwManaReportsWosOnlyId(Integer projectId, Serializable projectName, Serializable projectType,
			...
			Integer subActivityId, String subActivity, String woname, String priority, double sla, int woid,
			Integer woplanId, Date plannedStartDate, Date plannedEndDate, Date date, Date actualStartDate,
			Date actualEndDate, String signumId, String employeeName, String wostatus, String deliveryStatus,
			String failureReason, String statusComment, Integer parentWorkOrderId, String nodeType, String nodeNames) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof VwManaReportsWosOnlyId))
			return false;
		VwManaReportsWosOnlyId castOther = (VwManaReportsWosOnlyId) other;
