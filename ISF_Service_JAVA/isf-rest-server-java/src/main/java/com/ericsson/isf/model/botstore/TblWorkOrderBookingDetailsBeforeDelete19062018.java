...
/**
 * TblWorkOrderBookingDetailsBeforeDelete19062018 generated by hbm2java
 */
@Entity
@Table(name = "TBL_WORK_ORDER_BOOKING_DETAILS_BeforeDelete_19062018", schema = "transactionalData")
public class TblWorkOrderBookingDetailsBeforeDelete19062018 implements java.io.Serializable {

	private TblWorkOrderBookingDetailsBeforeDelete19062018Id id;

	public TblWorkOrderBookingDetailsBeforeDelete19062018() {
	}

	public TblWorkOrderBookingDetailsBeforeDelete19062018(TblWorkOrderBookingDetailsBeforeDelete19062018Id id) {
		this.id = id;
	}
	...
	public TblWorkOrderBookingDetailsBeforeDelete19062018Id getId() {
		return this.id;
	}

	public void setId(TblWorkOrderBookingDetailsBeforeDelete19062018Id id) {
		this.id = id;
	}
