...
/**
 * VwProjectDemadId generated by hbm2java
 */
@Embeddable
public class VwProjectDemadId implements java.io.Serializable {
	...
	public VwProjectDemadId() {
	}

	public VwProjectDemadId(int resourceRequestId, int onsiteCount, int remoteCount, Date startDate, Date endDate,
	...
	public VwProjectDemadId(Integer projectId, Integer marketAreaId, Serializable marketAreaName, int resourceRequestId,
			Serializable resourceType, Serializable requestType, int onsiteCount, int remoteCount,
			Serializable createdBy, Integer jobRoleId, Integer jobStageId, Integer onsiteLocationId,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof VwProjectDemadId))
			return false;
		VwProjectDemadId castOther = (VwProjectDemadId) other;
