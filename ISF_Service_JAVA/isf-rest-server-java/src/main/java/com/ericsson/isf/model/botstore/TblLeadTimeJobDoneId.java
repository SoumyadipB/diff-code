...
/**
 * TblLeadTimeJobDoneId generated by hbm2java
 */
@Embeddable
public class TblLeadTimeJobDoneId implements java.io.Serializable {
	...
	public TblLeadTimeJobDoneId() {
	}

	public TblLeadTimeJobDoneId(int projectId, int subActivityId, int bookingId, String executionType,
			String compliance) {
	...
	public TblLeadTimeJobDoneId(Serializable marketAreaName, Serializable customerName, String domain, Integer woNumber,
			String ticketNumber, String complaintType, int projectId, Serializable projectName, int subActivityId,
			String subactivity, String technology, String executionStatus, String engineer, Integer woplanId,
			String woCreatedDate, int bookingId, String task, String executionType, String wotaskStartDate,
			Double hours, String type, String status, Integer slaStatus, Integer reasonForMissedSla, Integer remarks,
			Integer avgEstdEffort, Serializable siteName, String woPlannedStartDateTime, String woActualStartDateTime,
			String woActualEndDateTime, Date woPlannedStartDate, Date woPlannedEndDate, Date woActualStartDate,
			Date woActualEndDate, Date date, Date woPlannedStartTime, Date woActualStartTime, Date woActualEndTime,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TblLeadTimeJobDoneId))
			return false;
		TblLeadTimeJobDoneId castOther = (TblLeadTimeJobDoneId) other;
