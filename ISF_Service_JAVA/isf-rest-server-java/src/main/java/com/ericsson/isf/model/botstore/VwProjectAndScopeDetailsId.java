...
/**
 * VwProjectAndScopeDetailsId generated by hbm2java
 */
@Embeddable
public class VwProjectAndScopeDetailsId implements java.io.Serializable {
	...
	private String domainSubDomainTechnologySubactivity;

	public VwProjectAndScopeDetailsId() {
	}

	public VwProjectAndScopeDetailsId(String flow, int projectId, Date projectStartDate) {
		this.flow = flow;
		this.projectId = projectId;
		this.projectStartDate = projectStartDate;
	}

	public VwProjectAndScopeDetailsId(String flow, int projectId, Serializable projectName, Date projectStartDate,
			...
			String subActivity, Boolean activityScopeStatus, String domainSubDomainTechnologySubactivity) {
		this.flow = flow;
		this.projectId = projectId;
		...
		this.domainSubDomainTechnologySubactivity = domainSubDomainTechnologySubactivity;
	}
	...
	@Column(name = "DomainSubDomainTechnologySubactivity", length = 899)
	public String getDomainSubDomainTechnologySubactivity() {
		return this.domainSubDomainTechnologySubactivity;
	}

	public void setDomainSubDomainTechnologySubactivity(String domainSubDomainTechnologySubactivity) {
		this.domainSubDomainTechnologySubactivity = domainSubDomainTechnologySubactivity;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof VwProjectAndScopeDetailsId))
			return false;
		VwProjectAndScopeDetailsId castOther = (VwProjectAndScopeDetailsId) other;
		...
		return ((this.getFlow() == castOther.getFlow()) || (this.getFlow() != null && castOther.getFlow() != null
				...
				&& ((this.getDomainSubDomainTechnologySubactivity() == castOther
						.getDomainSubDomainTechnologySubactivity())
						|| (this.getDomainSubDomainTechnologySubactivity() != null
								&& castOther.getDomainSubDomainTechnologySubactivity() != null
								&& this.getDomainSubDomainTechnologySubactivity()
										.equals(castOther.getDomainSubDomainTechnologySubactivity())));
	}
	...
	public int hashCode() {
		...
		result = 37 * result + (getDomainSubDomainTechnologySubactivity() == null ? 0
				: this.getDomainSubDomainTechnologySubactivity().hashCode());
		return result;
	}
