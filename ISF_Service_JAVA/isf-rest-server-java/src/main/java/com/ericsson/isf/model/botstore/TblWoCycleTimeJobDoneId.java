...
/**
 * TblWoCycleTimeJobDoneId generated by hbm2java
 */
@Embeddable
public class TblWoCycleTimeJobDoneId implements java.io.Serializable {
	...
	private String weekSubActivity;
	private BigDecimal cycleTime;

	public TblWoCycleTimeJobDoneId() {
	}

	public TblWoCycleTimeJobDoneId(int projectId, int subactivityId, int bookingId, String executionType,
			String compliance) {
	...
	public TblWoCycleTimeJobDoneId(Serializable marketAreaName, Serializable customerName, String domain,
			Integer woNumber, String ticketNumber, String complaintType, int projectId, Serializable projectName,
			int subactivityId, String subactivity, String technology, String executionStatus, String engineer,
			Integer woplanId, String woCreatedDate, int bookingId, String woactualStartDate, String woactualEndDate,
			String task, String executionType, String wotaskStartDate, Double hours, String type, String status,
			Integer slaStatus, Integer reasonForMissedSla, Integer remarks, Integer avgEstdEffort,
			...
			Double manualEffortCost, Integer estimatedCost, String compliance, Date date, Integer week, Integer year,
			String weekSubActivity, BigDecimal cycleTime) {
		...
		this.week = week;
		this.year = year;
		this.weekSubActivity = weekSubActivity;
	...
	@Column(name = "WOActualStartDate", length = 16)
	...
	@Column(name = "WOActualEndDate", length = 16)
	...
	@Column(name = "WeekSubActivity", length = 530)
	public String getWeekSubActivity() {
		return this.weekSubActivity;
	}

	public void setWeekSubActivity(String weekSubActivity) {
		this.weekSubActivity = weekSubActivity;
	}

	@Column(name = "Cycle Time", precision = 36)
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TblWoCycleTimeJobDoneId))
			return false;
		TblWoCycleTimeJobDoneId castOther = (TblWoCycleTimeJobDoneId) other;
		...
		return ((this.getMarketAreaName() == castOther.getMarketAreaName())
				...
				&& ((this.getCompliance() == castOther.getCompliance()) || (this.getCompliance() != null
						&& castOther.getCompliance() != null && this.getCompliance().equals(castOther.getCompliance())))
				...
				&& ((this.getWeekSubActivity() == castOther.getWeekSubActivity())
						|| (this.getWeekSubActivity() != null && castOther.getWeekSubActivity() != null
								&& this.getWeekSubActivity().equals(castOther.getWeekSubActivity())))
				&& ((this.getCycleTime() == castOther.getCycleTime()) || (this.getCycleTime() != null
						&& castOther.getCycleTime() != null && this.getCycleTime().equals(castOther.getCycleTime())));
	}
	...
	public int hashCode() {
		...
		result = 37 * result + (getWeekSubActivity() == null ? 0 : this.getWeekSubActivity().hashCode());
		result = 37 * result + (getCycleTime() == null ? 0 : this.getCycleTime().hashCode());
		return result;
	}
