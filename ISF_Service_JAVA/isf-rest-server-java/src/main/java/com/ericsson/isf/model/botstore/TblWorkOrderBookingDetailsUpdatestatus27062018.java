...
/**
 * TblWorkOrderBookingDetailsUpdatestatus27062018 generated by hbm2java
 */
@Entity
@Table(name = "TBL_WORK_ORDER_BOOKING_DETAILS_UPDATESTATUS_27062018", schema = "transactionalData")
public class TblWorkOrderBookingDetailsUpdatestatus27062018 implements java.io.Serializable {

	private TblWorkOrderBookingDetailsUpdatestatus27062018Id id;

	public TblWorkOrderBookingDetailsUpdatestatus27062018() {
	}

	public TblWorkOrderBookingDetailsUpdatestatus27062018(TblWorkOrderBookingDetailsUpdatestatus27062018Id id) {
		this.id = id;
	}
	...
	public TblWorkOrderBookingDetailsUpdatestatus27062018Id getId() {
		return this.id;
	}

	public void setId(TblWorkOrderBookingDetailsUpdatestatus27062018Id id) {
		this.id = id;
	}
