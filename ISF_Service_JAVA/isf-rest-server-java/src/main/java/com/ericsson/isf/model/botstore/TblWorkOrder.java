...
/**
 * TblWorkOrder generated by hbm2java
 */
@Entity
@Table(name = "TBL_WORK_ORDER", schema = "transactionalData")
public class TblWorkOrder implements java.io.Serializable {

	private TblWorkOrderId id;

	public TblWorkOrder() {
	}

	public TblWorkOrder(TblWorkOrderId id) {
		this.id = id;
	}
	...
	public TblWorkOrderId getId() {
		return this.id;
	}

	public void setId(TblWorkOrderId id) {
		this.id = id;
	}
