...
/**
 * TblVwIsfBotDetailsJobDoneId generated by hbm2java
 */
@Embeddable
public class TblVwIsfBotDetailsJobDoneId implements java.io.Serializable {
	...
	private String integratedRpa;
	private String usedRpa;
	private String bookedRpa;
	private String uploadedOn;

	public TblVwIsfBotDetailsJobDoneId() {
	}

	public TblVwIsfBotDetailsJobDoneId(String marketAreaId, String marketAreaName, String projectName) {
		this.marketAreaId = marketAreaId;
		this.marketAreaName = marketAreaName;
		this.projectName = projectName;
	}

	public TblVwIsfBotDetailsJobDoneId(String marketAreaId, String marketAreaName, String projectId, String projectName,
			...
			String fcstepDetailsId, String integratedRpa, String usedRpa, String bookedRpa, String uploadedOn) {
		this.marketAreaId = marketAreaId;
		this.marketAreaName = marketAreaName;
	...
	@Column(name = "MarketAreaName", nullable = false, length = 300)
	...
	@Column(name = "ProjectName", nullable = false, length = 300)
	...
	@Column(name = "TechnologyID", length = 30)
	...
	@Column(name = "DomainID", length = 30)
	...
	@Column(name = "subdomain", length = 300)
	...
	@Column(name = "SubActivityID", length = 30)
	...
	@Column(name = "SubActivity", length = 300)
	...
	@Column(name = "SubActivityFlowChartDefID", length = 30)
	...
	@Column(name = "FCStepDetailsID", length = 30)
	...
	@Column(name = "integrated RPA", length = 30)
	public String getIntegratedRpa() {
		return this.integratedRpa;
	}

	public void setIntegratedRpa(String integratedRpa) {
		this.integratedRpa = integratedRpa;
	}

	@Column(name = "used RPA", length = 30)
	public String getUsedRpa() {
		return this.usedRpa;
	}

	public void setUsedRpa(String usedRpa) {
		this.usedRpa = usedRpa;
	}

	@Column(name = "booked RPA", length = 30)
	public String getBookedRpa() {
		return this.bookedRpa;
	}

	public void setBookedRpa(String bookedRpa) {
		this.bookedRpa = bookedRpa;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TblVwIsfBotDetailsJobDoneId))
			return false;
		TblVwIsfBotDetailsJobDoneId castOther = (TblVwIsfBotDetailsJobDoneId) other;
