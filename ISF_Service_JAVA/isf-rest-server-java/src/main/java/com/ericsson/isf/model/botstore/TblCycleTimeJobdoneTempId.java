...
/**
 * TblCycleTimeJobdoneTempId generated by hbm2java
 */
@Embeddable
public class TblCycleTimeJobdoneTempId implements java.io.Serializable {
	...
	public TblCycleTimeJobdoneTempId() {
	}

	public TblCycleTimeJobdoneTempId(int projectId, int subactivityId, int bookingId, String executionType,
			String compliance) {
	...
	public TblCycleTimeJobdoneTempId(Serializable marketAreaName, Serializable customerName, String domain,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TblCycleTimeJobdoneTempId))
			return false;
		TblCycleTimeJobdoneTempId castOther = (TblCycleTimeJobdoneTempId) other;
