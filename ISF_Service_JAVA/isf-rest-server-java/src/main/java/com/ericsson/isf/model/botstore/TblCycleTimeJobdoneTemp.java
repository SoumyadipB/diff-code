...
/**
 * TblCycleTimeJobdoneTemp generated by hbm2java
 */
@Entity
@Table(name = "tbl_Cycle_Time_Jobdone_temp", schema = "transactionalData")
public class TblCycleTimeJobdoneTemp implements java.io.Serializable {

	private TblCycleTimeJobdoneTempId id;

	public TblCycleTimeJobdoneTemp() {
	}

	public TblCycleTimeJobdoneTemp(TblCycleTimeJobdoneTempId id) {
		this.id = id;
	}
	...
	@AttributeOverrides({ @AttributeOverride(name = "marketAreaName", column = @Column(name = "MarketAreaName")),
			...
			@AttributeOverride(name = "woactualStartDate", column = @Column(name = "WOActualStartDate", length = 23)),
			@AttributeOverride(name = "woactualEndDate", column = @Column(name = "WOActualEndDate", length = 23)),
	...
	public TblCycleTimeJobdoneTempId getId() {
		return this.id;
	}

	public void setId(TblCycleTimeJobdoneTempId id) {
		this.id = id;
	}
