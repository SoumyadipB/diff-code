...
/**
 * TblSubactivityFlowchartDefTemp13Id generated by hbm2java
 */
@Embeddable
public class TblSubactivityFlowchartDefTemp13Id implements java.io.Serializable {
	...
	public TblSubactivityFlowchartDefTemp13Id() {
	}

	public TblSubactivityFlowchartDefTemp13Id(int subActivityFlowChartDefId) {
		this.subActivityFlowChartDefId = subActivityFlowChartDefId;
	}

	public TblSubactivityFlowchartDefTemp13Id(int subActivityFlowChartDefId, Integer projectId, Integer subActivityId,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TblSubactivityFlowchartDefTemp13Id))
			return false;
		TblSubactivityFlowchartDefTemp13Id castOther = (TblSubactivityFlowchartDefTemp13Id) other;
