...
/**
 * TblCostPerSiteJobdoneTemp generated by hbm2java
 */
@Entity
@Table(name = "tbl_Cost_Per_Site_Jobdone_temp", schema = "transactionalData")
public class TblCostPerSiteJobdoneTemp implements java.io.Serializable {

	private TblCostPerSiteJobdoneTempId id;

	public TblCostPerSiteJobdoneTemp() {
	}

	public TblCostPerSiteJobdoneTemp(TblCostPerSiteJobdoneTempId id) {
		this.id = id;
	}
	...
	public TblCostPerSiteJobdoneTempId getId() {
		return this.id;
	}

	public void setId(TblCostPerSiteJobdoneTempId id) {
		this.id = id;
	}
