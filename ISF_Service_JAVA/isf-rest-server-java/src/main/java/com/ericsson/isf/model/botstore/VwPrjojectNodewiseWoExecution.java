...
/**
 * VwPrjojectNodewiseWoExecution generated by hbm2java
 */
@Entity
@Table(name = "VW_Prjoject_Nodewise_WO_Execution", schema = "dbo")
public class VwPrjojectNodewiseWoExecution implements java.io.Serializable {

	private VwPrjojectNodewiseWoExecutionId id;

	public VwPrjojectNodewiseWoExecution() {
	}

	public VwPrjojectNodewiseWoExecution(VwPrjojectNodewiseWoExecutionId id) {
		this.id = id;
	}
	...
	public VwPrjojectNodewiseWoExecutionId getId() {
		return this.id;
	}

	public void setId(VwPrjojectNodewiseWoExecutionId id) {
		this.id = id;
	}
