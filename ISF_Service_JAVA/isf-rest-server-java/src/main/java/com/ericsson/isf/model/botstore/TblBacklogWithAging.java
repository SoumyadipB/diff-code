...
/**
 * TblBacklogWithAging generated by hbm2java
 */
@Entity
@Table(name = "TBL_Backlog_With_Aging", schema = "transactionalData")
public class TblBacklogWithAging implements java.io.Serializable {

	private TblBacklogWithAgingId id;

	public TblBacklogWithAging() {
	}

	public TblBacklogWithAging(TblBacklogWithAgingId id) {
		this.id = id;
	}
	...
	public TblBacklogWithAgingId getId() {
		return this.id;
	}

	public void setId(TblBacklogWithAgingId id) {
		this.id = id;
	}
