...
/**
 * TblWorkOrderBeforeDeleteId generated by hbm2java
 */
@Embeddable
public class TblWorkOrderBeforeDeleteId implements java.io.Serializable {
	...
	public TblWorkOrderBeforeDeleteId() {
	}

	public TblWorkOrderBeforeDeleteId(int woid) {
		this.woid = woid;
	}

	public TblWorkOrderBeforeDeleteId(int woid, Integer woplanId, Date plannedStartDate, Date plannedEndDate,
			Date actualStartDate, Date actualEndDate, String signumId, String status, Date closedOn, Boolean active,
			String createdBy, Date createdDate, String lastModifiedBy, Date lastModifiedDate, String priority,
			String market, Integer vendor, Integer adhocWoid, String deliveryStatus, String failureReason,
			String description, String statusComment, Integer parentWorkOrderId, Integer workFlowVersion) {
		this.woid = woid;
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TblWorkOrderBeforeDeleteId))
			return false;
		TblWorkOrderBeforeDeleteId castOther = (TblWorkOrderBeforeDeleteId) other;
