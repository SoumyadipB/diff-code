...
/**
 * VwIsfWfDetailId generated by hbm2java
 */
@Embeddable
public class VwIsfWfDetailId implements java.io.Serializable {
	...
	private Integer automatedWfs;

	public VwIsfWfDetailId() {
	}

	public VwIsfWfDetailId(int projectId) {
		this.projectId = projectId;
	}

	public VwIsfWfDetailId(Integer marketAreaId, Serializable marketAreaName, int projectId, Serializable projectName,
			...
			Integer subActivityFlowChartDefId, Integer fcstepDetailsId, String executionType, Integer automatedWfs) {
	...
	@Column(name = "Automated WFs")
	public Integer getAutomatedWfs() {
		return this.automatedWfs;
	}

	public void setAutomatedWfs(Integer automatedWfs) {
		this.automatedWfs = automatedWfs;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof VwIsfWfDetailId))
			return false;
		VwIsfWfDetailId castOther = (VwIsfWfDetailId) other;
