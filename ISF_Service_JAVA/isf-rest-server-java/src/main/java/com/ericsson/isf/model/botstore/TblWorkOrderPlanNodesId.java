...
/**
 * TblWorkOrderPlanNodesId generated by hbm2java
 */
@Embeddable
public class TblWorkOrderPlanNodesId implements java.io.Serializable {
	...
	public TblWorkOrderPlanNodesId() {
	}

	public TblWorkOrderPlanNodesId(int wnid) {
		this.wnid = wnid;
	}

	public TblWorkOrderPlanNodesId(Integer woplanId, String nodeType, String nodeNames, String createdBy,
			Date createdDate, String lastModifiedBy, Date lastModifiedDate, int wnid) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TblWorkOrderPlanNodesId))
			return false;
		TblWorkOrderPlanNodesId castOther = (TblWorkOrderPlanNodesId) other;
