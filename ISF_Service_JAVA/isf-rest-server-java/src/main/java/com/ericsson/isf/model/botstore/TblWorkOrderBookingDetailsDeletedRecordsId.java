...
/**
 * TblWorkOrderBookingDetailsDeletedRecordsId generated by hbm2java
 */
@Embeddable
public class TblWorkOrderBookingDetailsDeletedRecordsId implements java.io.Serializable {
	...
	public TblWorkOrderBookingDetailsDeletedRecordsId() {
	}

	public TblWorkOrderBookingDetailsDeletedRecordsId(Integer bookingId, Integer woid, Integer taskId, Date startDate,
			Date endDate, Double hours, Integer parentBookingDetailsId, String type, String status, String signumId,
			String reason, String outputLink, Integer parallelcount, Date insertdate, String recordType) {
	...
	@Column(name = "RecordType", length = 10)
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TblWorkOrderBookingDetailsDeletedRecordsId))
			return false;
		TblWorkOrderBookingDetailsDeletedRecordsId castOther = (TblWorkOrderBookingDetailsDeletedRecordsId) other;

		return ((this.getBookingId() == castOther.getBookingId()) || (this.getBookingId() != null
				...
				&& ((this.getRecordType() == castOther.getRecordType())
						|| (this.getRecordType() != null && castOther.getRecordType() != null
								&& this.getRecordType().equals(castOther.getRecordType())));
	}
