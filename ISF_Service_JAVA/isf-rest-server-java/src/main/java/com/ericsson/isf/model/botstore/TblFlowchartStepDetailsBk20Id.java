...
/**
 * TblFlowchartStepDetailsBk20Id generated by hbm2java
 */
@Embeddable
public class TblFlowchartStepDetailsBk20Id implements java.io.Serializable {
	...
	public TblFlowchartStepDetailsBk20Id() {
	}

	public TblFlowchartStepDetailsBk20Id(int fcstepDetailsId) {
		this.fcstepDetailsId = fcstepDetailsId;
	}

	public TblFlowchartStepDetailsBk20Id(int fcstepDetailsId, Integer subActivityFlowChartDefId, Integer stepId,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TblFlowchartStepDetailsBk20Id))
			return false;
		TblFlowchartStepDetailsBk20Id castOther = (TblFlowchartStepDetailsBk20Id) other;
