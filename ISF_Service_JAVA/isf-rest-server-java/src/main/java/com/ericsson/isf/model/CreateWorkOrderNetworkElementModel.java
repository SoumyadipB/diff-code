...
public class CreateWorkOrderNetworkElementModel implements Serializable{
     ...
     * Copy constructor
     */
	public CreateWorkOrderNetworkElementModel(CreateWorkOrderNetworkElementModel sourceModel) {
	...
	public CreateWorkOrderNetworkElementModel() {
	}
	...
	public String toString() {
		return "CreateWorkOrderNetworkElementModel [executionPlanId=" + executionPlanId + ", wOPlanID=" + wOPlanID
				...
				+ subActivity + ", status=" + status + ", uploadedBy=" + uploadedBy + ", workOrderAutoSenseEnabled="
				+ workOrderAutoSenseEnabled + ", count=" + count + ", tableName=" + tableName + ", neTextName="
				+ neTextName + "]";
	}

	public CreateWorkOrderNetworkElementModel(int executionPlanId, int wOPlanID, int workOrderPlanID, int projectID, int scopeID,
