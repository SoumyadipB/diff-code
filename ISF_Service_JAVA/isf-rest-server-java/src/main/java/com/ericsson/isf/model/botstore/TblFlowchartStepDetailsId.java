...
/**
 * TblFlowchartStepDetailsId generated by hbm2java
 */
@Embeddable
public class TblFlowchartStepDetailsId implements java.io.Serializable {
	...
	public TblFlowchartStepDetailsId() {
	}

	public TblFlowchartStepDetailsId(int fcstepDetailsId) {
		this.fcstepDetailsId = fcstepDetailsId;
	}

	public TblFlowchartStepDetailsId(int fcstepDetailsId, Integer subActivityFlowChartDefId, Integer stepId,
			...
			String masterTask, Integer isIssue) {
		this.fcstepDetailsId = fcstepDetailsId;
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TblFlowchartStepDetailsId))
			return false;
		TblFlowchartStepDetailsId castOther = (TblFlowchartStepDetailsId) other;
		...
		return (this.getFcstepDetailsId() == castOther.getFcstepDetailsId())
				...
				&& ((this.getIsIssue() == castOther.getIsIssue()) || (this.getIsIssue() != null
						&& castOther.getIsIssue() != null && this.getIsIssue().equals(castOther.getIsIssue())));
	}
	...
	public int hashCode() {
		...
		result = 37 * result + (getIsIssue() == null ? 0 : this.getIsIssue().hashCode());
		return result;
	}
