...
/**
 * TblWoCostJobDoneTempId generated by hbm2java
 */
@Embeddable
public class TblWoCostJobDoneTempId implements java.io.Serializable {
	...
	public TblWoCostJobDoneTempId() {
	}

	public TblWoCostJobDoneTempId(Integer projectId, Serializable projectName, Integer woid, Integer subActivityId,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TblWoCostJobDoneTempId))
			return false;
		TblWoCostJobDoneTempId castOther = (TblWoCostJobDoneTempId) other;
