...
/**
 * TblSubactivityFlowchartDef14Id generated by hbm2java
 */
@Embeddable
public class TblSubactivityFlowchartDef14Id implements java.io.Serializable {
	...
	public TblSubactivityFlowchartDef14Id() {
	}

	public TblSubactivityFlowchartDef14Id(int subActivityFlowChartDefId) {
		this.subActivityFlowChartDefId = subActivityFlowChartDefId;
	}

	public TblSubactivityFlowchartDef14Id(int subActivityFlowChartDefId, Integer projectId, Integer subActivityId,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TblSubactivityFlowchartDef14Id))
			return false;
		TblSubactivityFlowchartDef14Id castOther = (TblSubactivityFlowchartDef14Id) other;
