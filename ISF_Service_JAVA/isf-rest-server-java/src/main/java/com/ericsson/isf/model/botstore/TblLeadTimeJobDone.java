...
/**
 * TblLeadTimeJobDone generated by hbm2java
 */
@Entity
@Table(name = "tbl_lead_time_JobDone", schema = "transactionalData")
public class TblLeadTimeJobDone implements java.io.Serializable {

	private TblLeadTimeJobDoneId id;

	public TblLeadTimeJobDone() {
	}

	public TblLeadTimeJobDone(TblLeadTimeJobDoneId id) {
		this.id = id;
	}
	...
	public TblLeadTimeJobDoneId getId() {
		return this.id;
	}

	public void setId(TblLeadTimeJobDoneId id) {
		this.id = id;
	}
