...
/**
 * TblSubactivityFlowchartDefBk12062018Id generated by hbm2java
 */
@Embeddable
public class TblSubactivityFlowchartDefBk12062018Id implements java.io.Serializable {
	...
	public TblSubactivityFlowchartDefBk12062018Id() {
	}

	public TblSubactivityFlowchartDefBk12062018Id(int subActivityFlowChartDefId) {
		this.subActivityFlowChartDefId = subActivityFlowChartDefId;
	}

	public TblSubactivityFlowchartDefBk12062018Id(int subActivityFlowChartDefId, Integer projectId,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TblSubactivityFlowchartDefBk12062018Id))
			return false;
		TblSubactivityFlowchartDefBk12062018Id castOther = (TblSubactivityFlowchartDefBk12062018Id) other;
