...
/**
 * TblFlowchartJsonUpdateStatusTemp13Id generated by hbm2java
 */
@Embeddable
public class TblFlowchartJsonUpdateStatusTemp13Id implements java.io.Serializable {
	...
	public TblFlowchartJsonUpdateStatusTemp13Id() {
	}

	public TblFlowchartJsonUpdateStatusTemp13Id(int statusId) {
		this.statusId = statusId;
	}

	public TblFlowchartJsonUpdateStatusTemp13Id(int statusId, Integer projectId, Integer subActivityId,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TblFlowchartJsonUpdateStatusTemp13Id))
			return false;
		TblFlowchartJsonUpdateStatusTemp13Id castOther = (TblFlowchartJsonUpdateStatusTemp13Id) other;
