...
/**
 * TblWorkOrderBeforeDelete generated by hbm2java
 */
@Entity
@Table(name = "TBL_WORK_ORDER_BeforeDelete", schema = "transactionalData")
public class TblWorkOrderBeforeDelete implements java.io.Serializable {

	private TblWorkOrderBeforeDeleteId id;

	public TblWorkOrderBeforeDelete() {
	}

	public TblWorkOrderBeforeDelete(TblWorkOrderBeforeDeleteId id) {
		this.id = id;
	}
	...
	public TblWorkOrderBeforeDeleteId getId() {
		return this.id;
	}

	public void setId(TblWorkOrderBeforeDeleteId id) {
		this.id = id;
	}
