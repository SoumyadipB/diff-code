...
/**
 * TblBacklogWithAgingTempId generated by hbm2java
 */
@Embeddable
public class TblBacklogWithAgingTempId implements java.io.Serializable {
	...
	public TblBacklogWithAgingTempId() {
	}

	public TblBacklogWithAgingTempId(int projectId, int subactivityid, int woid) {
		this.projectId = projectId;
		this.subactivityid = subactivityid;
		this.woid = woid;
	}

	public TblBacklogWithAgingTempId(Serializable marketAreaName, Serializable customerName, int projectId,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TblBacklogWithAgingTempId))
			return false;
		TblBacklogWithAgingTempId castOther = (TblBacklogWithAgingTempId) other;
