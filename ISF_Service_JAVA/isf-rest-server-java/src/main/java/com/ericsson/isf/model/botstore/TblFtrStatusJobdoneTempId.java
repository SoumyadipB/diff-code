...
/**
 * TblFtrStatusJobdoneTempId generated by hbm2java
 */
@Embeddable
public class TblFtrStatusJobdoneTempId implements java.io.Serializable {
	...
	public TblFtrStatusJobdoneTempId() {
	}

	public TblFtrStatusJobdoneTempId(int projectId, int subActivityId, int bookingId, String executionType) {
	...
	public TblFtrStatusJobdoneTempId(Integer woNumber, String ticketNumber, String complaintType, int projectId,
			Serializable projectName, Integer opportunityId, Integer domainId, int subActivityId, String subactivity,
			String technology, String executionStatus, String engineer, Integer woplanId, String woCreatedDate,
			int bookingId, String task, String executionType, String wotaskStartDate, String hours, String type,
			...
			Double manualEffortCost, Integer estimatedCost, Date date, Integer week, Serializable marketAreaName,
			Serializable customerName, String domain) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TblFtrStatusJobdoneTempId))
			return false;
		TblFtrStatusJobdoneTempId castOther = (TblFtrStatusJobdoneTempId) other;
