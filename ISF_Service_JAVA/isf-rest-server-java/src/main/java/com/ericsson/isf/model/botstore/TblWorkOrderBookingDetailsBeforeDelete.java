...
/**
 * TblWorkOrderBookingDetailsBeforeDelete generated by hbm2java
 */
@Entity
@Table(name = "TBL_WORK_ORDER_BOOKING_DETAILS_BeforeDelete", schema = "transactionalData")
public class TblWorkOrderBookingDetailsBeforeDelete implements java.io.Serializable {

	private TblWorkOrderBookingDetailsBeforeDeleteId id;

	public TblWorkOrderBookingDetailsBeforeDelete() {
	}

	public TblWorkOrderBookingDetailsBeforeDelete(TblWorkOrderBookingDetailsBeforeDeleteId id) {
		this.id = id;
	}
	...
	public TblWorkOrderBookingDetailsBeforeDeleteId getId() {
		return this.id;
	}

	public void setId(TblWorkOrderBookingDetailsBeforeDeleteId id) {
		this.id = id;
	}
