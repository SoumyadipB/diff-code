...
/**
 * TblPrjojectNodewiseWoExecutionJobDone generated by hbm2java
 */
@Entity
@Table(name = "tbl_Prjoject_Nodewise_WO_Execution_JobDone", schema = "transactionalData")
public class TblPrjojectNodewiseWoExecutionJobDone implements java.io.Serializable {

	private TblPrjojectNodewiseWoExecutionJobDoneId id;

	public TblPrjojectNodewiseWoExecutionJobDone() {
	}

	public TblPrjojectNodewiseWoExecutionJobDone(TblPrjojectNodewiseWoExecutionJobDoneId id) {
		this.id = id;
	}
	...
	public TblPrjojectNodewiseWoExecutionJobDoneId getId() {
		return this.id;
	}

	public void setId(TblPrjojectNodewiseWoExecutionJobDoneId id) {
		this.id = id;
	}
