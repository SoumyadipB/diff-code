...
/**
 * TblScopeidTaskMappingBk20Id generated by hbm2java
 */
@Embeddable
public class TblScopeidTaskMappingBk20Id implements java.io.Serializable {
	...
	public TblScopeidTaskMappingBk20Id() {
	}

	public TblScopeidTaskMappingBk20Id(int scopeTaskMappingId) {
		this.scopeTaskMappingId = scopeTaskMappingId;
	}

	public TblScopeidTaskMappingBk20Id(Integer projectId, Integer scopeId, Integer subActivityId, Integer taskId,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TblScopeidTaskMappingBk20Id))
			return false;
		TblScopeidTaskMappingBk20Id castOther = (TblScopeidTaskMappingBk20Id) other;
