...
/**
 * TblSubactivityFlowchartDefBk14062018Id generated by hbm2java
 */
@Embeddable
public class TblSubactivityFlowchartDefBk14062018Id implements java.io.Serializable {
	...
	public TblSubactivityFlowchartDefBk14062018Id() {
	}

	public TblSubactivityFlowchartDefBk14062018Id(int subActivityFlowChartDefId) {
		this.subActivityFlowChartDefId = subActivityFlowChartDefId;
	}

	public TblSubactivityFlowchartDefBk14062018Id(int subActivityFlowChartDefId, Integer projectId,
			Integer subActivityId, Serializable flowChartJson, Integer sourceProjectId, String createdBy,
			Date createdDate, Boolean active, Integer versionNumber, String type, String lastModifiedBy,
			Date lastModifiedDate, String workFlowName) {
		this.subActivityFlowChartDefId = subActivityFlowChartDefId;
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TblSubactivityFlowchartDefBk14062018Id))
			return false;
		TblSubactivityFlowchartDefBk14062018Id castOther = (TblSubactivityFlowchartDefBk14062018Id) other;
