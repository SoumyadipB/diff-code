...
/**
 * TblWorkOrderBk25062018Id generated by hbm2java
 */
@Embeddable
public class TblWorkOrderBk25062018Id implements java.io.Serializable {
	...
	public TblWorkOrderBk25062018Id() {
	}

	public TblWorkOrderBk25062018Id(int woid) {
		this.woid = woid;
	}

	public TblWorkOrderBk25062018Id(int woid, Integer woplanId, Date plannedStartDate, Date plannedEndDate,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TblWorkOrderBk25062018Id))
			return false;
		TblWorkOrderBk25062018Id castOther = (TblWorkOrderBk25062018Id) other;
