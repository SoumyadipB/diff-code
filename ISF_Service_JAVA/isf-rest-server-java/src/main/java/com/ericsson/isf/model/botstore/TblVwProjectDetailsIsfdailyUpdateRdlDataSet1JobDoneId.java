...
/**
 * TblVwProjectDetailsIsfdailyUpdateRdlDataSet1JobDoneId generated by hbm2java
 */
@Embeddable
public class TblVwProjectDetailsIsfdailyUpdateRdlDataSet1JobDoneId implements java.io.Serializable {
	...
	public TblVwProjectDetailsIsfdailyUpdateRdlDataSet1JobDoneId() {
	}

	public TblVwProjectDetailsIsfdailyUpdateRdlDataSet1JobDoneId(String projectId, String projectName, String createdBy,
			char isDeleted) {
	...
	public TblVwProjectDetailsIsfdailyUpdateRdlDataSet1JobDoneId(String projectId, String projectName,
			String projectType, String serviceArea, String opportunityName, String opportunityCode, String countryName,
			String customerName, String marketAreaName, String companyName, String cpm, String projectCreator,
			String startDate, String enddate, String projectDescription, String createdBy, String createdOn,
			String status, String operationalManager, char isDeleted) {
		this.projectId = projectId;
		this.projectName = projectName;
	...
	@Column(name = "ProjectID", nullable = false, length = 15)
	...
	@Column(name = "ServiceArea", length = 500)
	...
	@Column(name = "OpportunityName", length = 500)
	...
	@Column(name = "OpportunityCode", length = 500)
	...
	@Column(name = "MarketAreaName", length = 100)
	...
	@Column(name = "ProjectCreator", length = 500)
	...
	@Column(name = "StartDate", length = 35)
	...
	@Column(name = "OperationalManager", length = 500)
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TblVwProjectDetailsIsfdailyUpdateRdlDataSet1JobDoneId))
			return false;
		TblVwProjectDetailsIsfdailyUpdateRdlDataSet1JobDoneId castOther = (TblVwProjectDetailsIsfdailyUpdateRdlDataSet1JobDoneId) other;
		...
		return ((this.getProjectId() == castOther.getProjectId()) || (this.getProjectId() != null
				...
				&& (this.getIsDeleted() == castOther.getIsDeleted());
	}
	...
	public int hashCode() {
		...
		result = 37 * result + this.getIsDeleted();
		return result;
	}
