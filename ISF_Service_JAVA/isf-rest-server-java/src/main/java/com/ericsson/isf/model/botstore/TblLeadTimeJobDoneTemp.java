...
/**
 * TblLeadTimeJobDoneTemp generated by hbm2java
 */
@Entity
@Table(name = "tbl_lead_time_JobDone_temp", schema = "transactionalData")
public class TblLeadTimeJobDoneTemp implements java.io.Serializable {

	private TblLeadTimeJobDoneTempId id;

	public TblLeadTimeJobDoneTemp() {
	}

	public TblLeadTimeJobDoneTemp(TblLeadTimeJobDoneTempId id) {
		this.id = id;
	}
	...
	public TblLeadTimeJobDoneTempId getId() {
		return this.id;
	}

	public void setId(TblLeadTimeJobDoneTempId id) {
		this.id = id;
	}
