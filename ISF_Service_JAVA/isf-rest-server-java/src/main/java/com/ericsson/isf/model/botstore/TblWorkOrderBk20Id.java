...
/**
 * TblWorkOrderBk20Id generated by hbm2java
 */
@Embeddable
public class TblWorkOrderBk20Id implements java.io.Serializable {
	...
	public TblWorkOrderBk20Id() {
	}

	public TblWorkOrderBk20Id(int woid) {
		this.woid = woid;
	}

	public TblWorkOrderBk20Id(int woid, Integer woplanId, Date plannedStartDate, Date plannedEndDate,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TblWorkOrderBk20Id))
			return false;
		TblWorkOrderBk20Id castOther = (TblWorkOrderBk20Id) other;
