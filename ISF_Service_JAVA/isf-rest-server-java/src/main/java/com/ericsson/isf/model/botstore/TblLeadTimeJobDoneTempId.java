...
/**
 * TblLeadTimeJobDoneTempId generated by hbm2java
 */
@Embeddable
public class TblLeadTimeJobDoneTempId implements java.io.Serializable {
	...
	private String woActualEndDateTime;
	...
	public TblLeadTimeJobDoneTempId() {
	}

	public TblLeadTimeJobDoneTempId(int projectId, int subActivityId, int bookingId, String executionType,
			String compliance) {
	...
	public TblLeadTimeJobDoneTempId(Serializable marketAreaName, Serializable customerName, String domain,
			...
			Integer woplanId, String woCreatedDate, int bookingId, String task, String executionType,
			String wotaskStartDate, Double hours, String type, String status, Integer slaStatus,
			Integer reasonForMissedSla, Integer remarks, Integer avgEstdEffort, Serializable siteName,
			String woPlannedStartDateTime, String woActualStartDateTime, String woActualEndDateTime,
			Date woPlannedStartDate, Date woPlannedEndDate, Date woActualStartDate, Date woActualEndDate, Date date,
			Date woPlannedStartTime, Date woActualStartTime, Date woActualEndTime, Double manualEffortCost,
			Integer estimatedCost, String compliance) {
	...
	@Column(name = "WO Actual End DateTime", length = 50)
	public String getWoActualEndDateTime() {
		return this.woActualEndDateTime;
	}

	public void setWoActualEndDateTime(String woActualEndDateTime) {
		this.woActualEndDateTime = woActualEndDateTime;
	}
	...
	@Column(name = "WO PLanned End Date", length = 10)
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TblLeadTimeJobDoneTempId))
			return false;
		TblLeadTimeJobDoneTempId castOther = (TblLeadTimeJobDoneTempId) other;
