...
/**
 * TblWorkOrderBookingDetailsStatusChange7062018Id generated by hbm2java
 */
@Embeddable
public class TblWorkOrderBookingDetailsStatusChange7062018Id implements java.io.Serializable {
	...
	public TblWorkOrderBookingDetailsStatusChange7062018Id() {
	}

	public TblWorkOrderBookingDetailsStatusChange7062018Id(int bookingId) {
		this.bookingId = bookingId;
	}

	public TblWorkOrderBookingDetailsStatusChange7062018Id(int bookingId, Integer woid, Integer taskId, Date startDate,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TblWorkOrderBookingDetailsStatusChange7062018Id))
			return false;
		TblWorkOrderBookingDetailsStatusChange7062018Id castOther = (TblWorkOrderBookingDetailsStatusChange7062018Id) other;
