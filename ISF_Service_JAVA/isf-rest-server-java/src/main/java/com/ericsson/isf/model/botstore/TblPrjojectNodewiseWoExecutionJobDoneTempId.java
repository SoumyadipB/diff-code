...
/**
 * TblPrjojectNodewiseWoExecutionJobDoneTempId generated by hbm2java
 */
@Embeddable
public class TblPrjojectNodewiseWoExecutionJobDoneTempId implements java.io.Serializable {
	...
	public TblPrjojectNodewiseWoExecutionJobDoneTempId() {
	}

	public TblPrjojectNodewiseWoExecutionJobDoneTempId(int bookingId) {
		this.bookingId = bookingId;
	}

	public TblPrjojectNodewiseWoExecutionJobDoneTempId(Integer marketAreaId, Serializable marketAreaName,
			Integer projectId, Serializable projectName, Integer customerId, Serializable customerName,
			Integer technologyId, String technology, Integer domainId, String domain, String subdomain,
			Integer subActivityId, String subActivity, String activity, Integer woid, Integer woplanId,
			Date woActualStartDate, Date woActualEndDate, Date woPlannedStartDate, Date woPlannedEndDate,
			String woSignum, String woStatus, String woname, Double sla, String nodeType, String nodeNames,
			String executionType, Double taskEstimatedEfforts, Double woEstimatedEfforts, Integer taskId, String task,
			int bookingId, Date bookStartDate, Date bookEndDate, Double hours, Integer parentBookingDetailsId,
			String type, String status, String signumId, String reason, String outputLink) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TblPrjojectNodewiseWoExecutionJobDoneTempId))
			return false;
		TblPrjojectNodewiseWoExecutionJobDoneTempId castOther = (TblPrjojectNodewiseWoExecutionJobDoneTempId) other;
