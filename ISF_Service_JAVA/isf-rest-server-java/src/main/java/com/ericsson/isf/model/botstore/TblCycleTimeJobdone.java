...
/**
 * TblCycleTimeJobdone generated by hbm2java
 */
@Entity
@Table(name = "tbl_Cycle_Time_Jobdone", schema = "transactionalData")
public class TblCycleTimeJobdone implements java.io.Serializable {

	private TblCycleTimeJobdoneId id;

	public TblCycleTimeJobdone() {
	}

	public TblCycleTimeJobdone(TblCycleTimeJobdoneId id) {
		this.id = id;
	}
	...
	public TblCycleTimeJobdoneId getId() {
		return this.id;
	}

	public void setId(TblCycleTimeJobdoneId id) {
		this.id = id;
	}
