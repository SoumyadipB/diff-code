...
public class ErisiteReportDataService {
	...
	/*
	 * @Transactional public List<RpaBotExecutionDetailModel>
	 * getRpaBotExecutionDetail(String startDate, String endDate) {
	 * 
	 * return botMigrationDao.getRpaBotExecutionDetail(startDate, endDate);
	 * 
	 * }
	 */
	...
	private void downloadWorkPlanFullStructure(String bearerToken) throws JsonParseException, JsonMappingException, IOException {
		...
		for(Object ob:data) {
			...
			System.out.println("WorkPlanID ========= >"+workPlanData.getWorkPlanID());
	...
	private void downloadActivityFullStructure(int id, String bearerToken) throws JsonParseException, JsonMappingException, IOException {
		...
		for(Object ob:data) {
			...
			System.out.println(activityDataModel.getName());
