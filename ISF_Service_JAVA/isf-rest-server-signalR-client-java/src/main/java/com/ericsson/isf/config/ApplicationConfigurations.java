...
public class ApplicationConfigurations {
	...
	private void init() {
		try {
			...
			PropertiesConfiguration configuration3 = new PropertiesConfiguration(fileLocation + "/database.properties");
			PropertiesConfiguration configuration4 = new PropertiesConfiguration(fileLocation + "/swagger.properties");
			...
			configuration3.setReloadingStrategy(new FileChangedReloadingStrategy());
			configuration4.setReloadingStrategy(new FileChangedReloadingStrategy());

			// add config sources.
			config.addConfiguration(configuration);
			config.addConfiguration(configuration2);
			config.addConfiguration(configuration3);
			config.addConfiguration(configuration4);
