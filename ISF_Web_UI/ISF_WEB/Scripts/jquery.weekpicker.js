( function( $, window, document, undefined ) {
    ...
    $.extend( WeekPicker.prototype, {
        ...
        onSelect: function( dateText, dpInstance ) {
            ...
            //var  endOfWeek = function (weekNo, y) {
            ...
            //var endDateWeek
            //var endOfWeek = getDateRangeOfWeek(week, year);
            ...
            if (typeof afterSelect !== 'undefined') {
                afterSelect(text);
            }

            if (typeof afterSelectOnLayoutPage !== 'undefined') {
                afterSelectOnLayoutPage(text);
            }
        }
    } );
