...
(function () {
    ...
    var options = {
        ...
        colorPalette: [
            { content: 'transparent', icon: '../Scripts/Rappid/apps/KitchenSink/assets/transparent-icon.png' },
            { content: '#F6F6F6' },
            { content: '#DcD7D7' },
            { content: '#8F8F8F' },
            { content: '#C6C7E2' },
        ...
        myArrayOfResponsible:[
            {value: 'MA', content: 'MA'},
            { value: 'GLOBAL', content: 'GLOBAL'},
            {value: 'ASP', content: 'ASP'},
        ],
        outputUploadArr: [
            { value: 'NO', content: 'No' },
    ...
    App.config.inspector = {
        ...
        'ericsson.Manual': {
            inputs: {
                ...
                tool: {
                    ...
                    label: 'Tools',
                    group: 'attributes',
                    options: 'myArrayOfTools',
                    index: 4
                },
                responsible: {
                    type: 'select',
                    group: 'attributes',
                    options: options.myArrayOfResponsible,
                    index: 5
                },
                workInstruction: {
                    type: 'select',                    
                    group: 'attributes',
                    options: 'myArrayOfWorkInstruction',
                    index: 6
                },
                cellStartRule: {
                    type: 'startRuleButton',
                    group: 'attributes',
                    index: 8,
                    value: false,
                },
        ...
        'ericsson.Automatic': {
            inputs: {
                ...
                //        }
                //    },
                //    // options: [{ value: "Manual", content: "Manual" }, { value: "Automatic", content: "Automatic" }],                   
                //    index: 2
                //},
                ...
                rpaid: {
                    ...
                    type: 'select',
                    group: 'attributes',
                    options: 'myArrayOfRPAID',
                    index: 4
                },
                cascadeInput: {
                    type: 'select',
                    group: 'attributes',
                    options: options.cascadeInputArr,
                    index: 5,
                    defaultValue: 'No'
                    //overwrite:true
                },
                ...
                outputUpload:{
                    type: 'select',
                    group: 'attributes',
                    options: options.outputUploadArr,
                    index: 8,
                    defaultValue:'NO'
                },   
                addEditURL: {
