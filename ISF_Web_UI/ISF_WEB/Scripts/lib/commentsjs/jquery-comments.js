...
(function (factory) {
    ...
    var Comments = {
        ...
        createCommentingFieldElement: function(parentId, existingCommentId, isMain) {
            ...
            //controlRow.prepend(saveButton).prepend(flagDiv).prepend(notificationDiv);
        ...
        createCommentWrapperElement: function(commentModel) {
            ...
            if (commentModel.context === null) {
                ...
                var name = $('<span/>', {
                    'data-user-id': commentModel.creator,
                    'text': commentModel.createdByCurrentUser ? this.options.textFormatter(this.options.youText) : commentModel.fullname + ":"// "[" + commentModel.context + "]" + ":"
                });
            }
