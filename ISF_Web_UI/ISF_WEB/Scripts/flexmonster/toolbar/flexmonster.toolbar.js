...
FlexmonsterToolbar.prototype.getTabs = function () {
    ...
    // Connect tab
    tabs.push({
        title: Labels.connect, id: "fm-tab-format", icon: this.icons.connect,
        menu: [
            { title: "Project Details", args: "vw_ProjectDetails", handler: this.getReportsHandler, icon: this.icons.connect_csv },
            { title: "Project Scope", args: "vw_ProjectScope", handler: this.getReportsHandler, icon: this.icons.connect_csv },
            { title: "Project Tasks", args: "vw_ProjectTasks_WF", handler: this.getReportsHandler, icon: this.icons.connect_csv },
            { title: "Project Demand", args: "vw_ProjectDemand", handler: this.getReportsHandler, icon: this.icons.connect_csv },
            { title: "Demand FullFilment", args: "vw_ProjectDemadFullfilment", handler: this.getReportsHandler, icon: this.icons.connect_csv },
            { title: "Project WOs", args: "vw_Project_WOs", handler: this.getReportsHandler, icon: this.icons.connect_csv },
            { title: "Project WO Execution", args: "vw_Project_WO_Execution", handler: this.getReportsHandler, icon: this.icons.connect_csv },
            { title: "MasterData Subactivity", args: "vw_MasterData_Subactivity", handler: this.getReportsHandler, icon: this.icons.connect_csv },
            { title: "MasterData TaskDetails", args: "vw_MasterData_TaskDetails", handler: this.getReportsHandler, icon: this.icons.connect_csv }
    ...
    // ISF Reports
    //tabs.push({
    //    title: Labels.format, id: "fm-tab-format", icon: this.icons.format,
    //    menu: [
    //        { title: "Project Details", args: "vw_ProjectDetails", handler: this.getReportsHandler, icon: this.icons.format_conditional },
    //        { title: "Project Scope", args: "vw_ProjectScope", handler: this.getReportsHandler, icon: this.icons.format_conditional },
    //        { title: "Project Tasks", args: "vw_ProjectTasks_WF", handler: this.getReportsHandler, icon: this.icons.format_conditional },
    //        { title: "Project Demand", args: "vw_ProjectDemand", handler: this.getReportsHandler, icon: this.icons.format_conditional },
    //        { title: "Demand FullFilment", args: "vw_ProjectDemadFullfilment", handler: this.getReportsHandler, icon: this.icons.format_conditional },
    //        { title: "Project WOs", args: "vw_Project_WOs", handler: this.getReportsHandler, icon: this.icons.format_conditional },
    //        { title: "Project WO Execution", args: "vw_Project_WO_Execution", handler: this.getReportsHandler, icon: this.icons.format_conditional },
    //        { title: "MasterData Subactivity", args: "vw_MasterData_Subactivity", handler: this.getReportsHandler, icon: this.icons.format_conditional },
    //        { title: "MasterData TaskDetails", args: "vw_MasterData_TaskDetails", handler: this.getReportsHandler, icon: this.icons.format_conditional }
    //          ]
    //});
...
//Reports tab
FlexmonsterToolbar.prototype.getReportsHandler = function (view) {
    this.pivot = new Flexmonster({
        container: "pivotContainer",
        toolbar: true,
        report: {
            dataSource: {
                dataSourceType: "ocsv", //Data Compressor
                /* URL to the Data Compressor .NET */
                filename: service_java_URL + "appUtil/generateFlexMonsterReport/view/" + view
             }
        },
        componentFolder: UiRootDir + "/Scripts/flexmonster/",
        licenseKey: "Z7ZS-XD210R-6D0Y0J-1P5O48" //license valid till 1st sep'2018
    });
}
